...
object RecipesRepository {
    val dishes = listOf(
        ...
        Recipes(R.string.dish_2, R.string.dish2_name, R.drawable.chapathi_with_fish_gravy, R.string.desc2),
        Recipes(R.string.dish_3, R.string.dish3_name, R.drawable.chicken_bbq, R.string.desc3),
        Recipes(R.string.dish_4, R.string.dish4_name, R.drawable.chicken_gravy, R.string.desc4),
        ...
        Recipes(R.string.dish_11, R.string.dish11_name, R.drawable.fish_fry, R.string.desc11),
        Recipes(R.string.dish_12, R.string.dish12_name, R.drawable.guntur_chicken_gravy, R.string.desc12),
        Recipes(R.string.dish_13, R.string.dish13_name, R.drawable.home_made_brownie, R.string.desc13),
        Recipes(R.string.dish_14, R.string.dish14_name, R.drawable.home_made_cake, R.string.desc14),
        Recipes(R.string.dish_15, R.string.dish15_name, R.drawable.home_made_falooda, R.string.desc15),
        Recipes(R.string.dish_16, R.string.dish16_name, R.drawable.home_made_jelly, R.string.desc16),
        Recipes(R.string.dish_17, R.string.dish17_name, R.drawable.home_made_pizza, R.string.desc17),
        Recipes(R.string.dish_18, R.string.dish18_name, R.drawable.kaju_katli, R.string.desc18),
        Recipes(R.string.dish_19, R.string.dish19_name, R.drawable.mutton_gravy_rice, R.string.desc19),
        ...
        Recipes(R.string.dish_22, R.string.dish22_name, R.drawable.quail_gravy, R.string.desc22),
